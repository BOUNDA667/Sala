...
class _$CommentImpl implements _Comment {
  _$CommentImpl(
      ...
      @HiveField(5) required this.todoId,
      @HiveField(6) this.todo});
  ...
  @override
  String toString() {
    return 'Comment(id: $id, content: $content, createdAt: $createdAt, userId: $userId, user: $user, todoId: $todoId, todo: $todo)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, content, createdAt, userId, user, todoId, todo);
...
abstract class _Comment implements Comment {
  factory _Comment(
      ...
      @HiveField(4) final User? user,
      @HiveField(5) required final int todoId,
      @HiveField(6) final Todo? todo}) = _$CommentImpl;
